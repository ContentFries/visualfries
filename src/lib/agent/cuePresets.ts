...
function timed(start: number, length: number, duration: number): { start: number; end: number } {
...
function transitionTimes(duration: number): number[] {
...
export function createAgentCuePreset(input: CreateAgentCuePresetInput): AgentCueFile {
