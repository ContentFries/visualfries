...
export class HtmlTextHook implements IComponentHook {
	...
	#htmlEl: HTMLDivElement | undefined = undefined;
	#wrapperEl: HTMLDivElement | undefined = undefined;
	private domManager: DomManager;
	private componentsManager: ComponentsManager;

	constructor(cradle: { domManager: DomManager; componentsManager: ComponentsManager }) {
	...
	private buildHtmlElements() {
		...
		if (componentData.type !== 'TEXT') return { wrapper: undefined, element: undefined };
	...
	async #handleSetup() {
		...
		this.#wrapperEl = wrapper as HTMLDivElement;
		this.#htmlEl = element as HTMLDivElement;
		...
		const background =
			componentData.type === 'TEXT' ? componentData.appearance.background : undefined;
