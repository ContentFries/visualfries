...
let activeFontProviders: FontProvider[] = [createGoogleFontsProvider()];
 ...
 */
export function setFontProviders(providers?: FontProvider[]) {
 ...
 */
export async function fetchFont(font: string, text?: string): Promise<ArrayBuffer | null> {
