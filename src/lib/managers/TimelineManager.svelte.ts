...
export class TimelineManager {
	...
	#progressTimeline: gsap.core.Tween | undefined = undefined;
	#watchTicker!: () => void;
	...
	constructor(cradle: { stateManager: StateManager; eventManager: EventManager; loop: boolean }) {
	...
	add(timeline: gsap.core.Timeline, position?: gsap.Position) {
